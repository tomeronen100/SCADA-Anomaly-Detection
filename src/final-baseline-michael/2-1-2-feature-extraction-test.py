# feature_extract_tables_test.py
...
def build_tables(
    ...
    regs = df[reg_cols]
    inter = df[inter_col].rename("inter_arrival_time")
    ...
    stats_t2 = compute_stats(table2, duration_cols)
...
if __name__ == "__main__":
    # build_tables(in_csv="data/final_226_snd_test.csv")
    build_tables(in_csv="data/final_161_snd_test.csv")
